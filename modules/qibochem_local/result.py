...
from qibochem_local.optimization import (
    allocate_shots,
    measurement_basis_rotations,
)
from errormitigation import expectation_from_samples_with_rem 
...
def pauli_term_measurement_expectation(pauli_term, frequencies, qubit_map):
    ...
    return expectation_from_samples_with_rem(z_only_ham, frequencies, qubit_map=qubit_map, rem = READOUT_ERROR_MITIGATION)#z_only_ham.expectation_from_samples(frequencies, qubit_map=qubit_map)
